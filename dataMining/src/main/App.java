...
public class App {
	...
	public static void main(String[] args) throws Exception {
		...
		String fileDataSetTest="C:/Users/RobertoPrado/Desktop/DataMining/DataSetTest/dataset-test.arff";
		System.out.println(">>>Archivo de entrada: "+fileDataSetTest);
		...
		clasificador.train_test_Validation("NaiveBayes", fileDataSetTrain,fileDataSetTest);
		...
		System.out.println(">>>Creación de dataset sin clasificar del libro "+libro+"");
